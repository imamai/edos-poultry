...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <OfflineProvider>
      <div className="flex min-h-screen flex-col pb-20 [@media(display-mode:standalone)]:pb-[calc(5rem+env(safe-area-inset-bottom))] print:pb-0">
        <header className="sticky top-0 z-20 border-b border-line bg-paper/90 px-5 py-3 [@media(display-mode:standalone)]:pb-3 [@media(display-mode:standalone)]:pt-[calc(0.75rem+env(safe-area-inset-top))] backdrop-blur print:hidden">
